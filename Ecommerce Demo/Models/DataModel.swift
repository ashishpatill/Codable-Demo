...
/*
 ...
 "name": "Mens Wear",
 "products": [],
 "child_categories": [4, 5, 6]
 }, {
 "id": 4,
 "name": "Bottom Wear",
 "products": [],
 "child_categories": [2, 8]
 }, {
 "id": 5,
 "name": "Foot Wear",
 "products": [],
 "child_categories": [1, 9]
 }, {
 "id": 6,
 "name": "Upper Wear",
 "products": [],
 "child_categories": [7, 10]
 }, {
 "id": 11,
 "name": "Electronics",
 "products": [],
 "child_categories": [12, 13]
 }, {
 "id": 12,
 "name": "Mobiles",
 "products": [],
 "child_categories": [14, 15]
 }, {
 "id": 13,
 "name": "Laptops",
 "products": [],
 "child_categories": [16, 17]
 }],
 "rankings": [{
...
struct ViewedRanking: Codable {
    var ranking: String
    var products: [MostViewedProduct]
}

struct MostViewedProduct: Codable {
    var id: Int?
    var view_count: Int?
}

struct OrderedRanking: Codable {
    var ranking: String
    var products: [MostOrderedProduct]
}

struct MostOrderedProduct: Codable {
    var id: Int?
    var order_count: Int?
}

struct SharedRanking: Codable {
    var ranking: String
    var products: [MostSharedProduct]
}

struct MostSharedProduct: Codable {
    var id: Int?
    var shares: Int?
}
